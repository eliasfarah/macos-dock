...
export class DockManager {
    ...
    _redisplayApps() {
        ...
        // alike, in the order the model keeps — see RecentApps.visibleIds().
        // This is drawn as-is, not re-sorted here: the model already
        // decides whether an id's slot moves (quitting never does; reopening
        // one that had aged out of view does) or stays put (reopening one
        // still on screen does not).
